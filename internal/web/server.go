...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("POST /assays/yaml/to-form", s.protected(s.handleAssayYAMLToForm))
	mux.HandleFunc("POST /assays/form/edit", s.protected(s.handleAssayFormEdit))
	mux.HandleFunc("POST /assays/form/save", s.protected(s.handleAssayFormSave))
	mux.HandleFunc("POST /assays/form/to-yaml", s.protected(s.handleAssayFormToYAML))
	...
	mux.HandleFunc("GET /results/report", s.protected(s.handleResultsReport))
